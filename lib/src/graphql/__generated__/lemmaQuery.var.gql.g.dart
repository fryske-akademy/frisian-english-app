...
part of 'lemmaQuery.var.gql.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

Serializer<GlemmasVars> _$glemmasVarsSerializer = new _$GlemmasVarsSerializer();
Serializer<GdetaillinkVars> _$gdetaillinkVarsSerializer =
    new _$GdetaillinkVarsSerializer();

class _$GlemmasVarsSerializer implements StructuredSerializer<GlemmasVars> {
  @override
  final Iterable<Type> types = const [GlemmasVars, _$GlemmasVars];
  @override
  final String wireName = 'GlemmasVars';

  @override
  Iterable<Object?> serialize(Serializers serializers, GlemmasVars object,
  ...
  @override
  GlemmasVars deserialize(Serializers serializers, Iterable<Object?> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new GlemmasVarsBuilder();
...
class _$GlemmasVars extends GlemmasVars {
  @override
  final int max;
  @override
  final int offset;
  ...
  factory _$GlemmasVars([void Function(GlemmasVarsBuilder)? updates]) =>
      (new GlemmasVarsBuilder()..update(updates))._build();
  ...
  _$GlemmasVars._(
      ...
      : super._() {
    BuiltValueNullFieldError.checkNotNull(max, r'GlemmasVars', 'max');
    BuiltValueNullFieldError.checkNotNull(offset, r'GlemmasVars', 'offset');
    BuiltValueNullFieldError.checkNotNull(lang, r'GlemmasVars', 'lang');
    BuiltValueNullFieldError.checkNotNull(
        searchterm, r'GlemmasVars', 'searchterm');
    BuiltValueNullFieldError.checkNotNull(
        sensitive, r'GlemmasVars', 'sensitive');
    BuiltValueNullFieldError.checkNotNull(
        lexiconFallback, r'GlemmasVars', 'lexiconFallback');
    BuiltValueNullFieldError.checkNotNull(
        englishTranslations, r'GlemmasVars', 'englishTranslations');
  }

  @override
  GlemmasVars rebuild(void Function(GlemmasVarsBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  GlemmasVarsBuilder toBuilder() => new GlemmasVarsBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is GlemmasVars &&
        max == other.max &&
        offset == other.offset &&
        lang == other.lang &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'GlemmasVars')
          ..add('max', max)
          ..add('offset', offset)
          ..add('lang', lang)
...
class GlemmasVarsBuilder implements Builder<GlemmasVars, GlemmasVarsBuilder> {
  _$GlemmasVars? _$v;
  ...
  @override
  void replace(GlemmasVars other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$GlemmasVars;
  }

  @override
  void update(void Function(GlemmasVarsBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  GlemmasVars build() => _build();

  _$GlemmasVars _build() {
    final _$result = _$v ??
        new _$GlemmasVars._(
            max: BuiltValueNullFieldError.checkNotNull(
                max, r'GlemmasVars', 'max'),
            offset: BuiltValueNullFieldError.checkNotNull(
                offset, r'GlemmasVars', 'offset'),
            lang: BuiltValueNullFieldError.checkNotNull(
                lang, r'GlemmasVars', 'lang'),
