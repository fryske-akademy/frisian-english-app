...
part of 'autocompleteQuery.data.gql.dart';
...
Serializer<GautocompleteData_lemmasearch_message>
    _$gautocompleteDataLemmasearchMessageSerializer =
    new _$GautocompleteData_lemmasearch_messageSerializer();
...
class _$GautocompleteData_lemmasearch_messageSerializer
    implements StructuredSerializer<GautocompleteData_lemmasearch_message> {
  @override
  final Iterable<Type> types = const [
  ...
  @override
  final String wireName = 'GautocompleteData_lemmasearch_message';

  @override
  Iterable<Object?> serialize(
      Serializers serializers, GautocompleteData_lemmasearch_message object,
      {FullType specifiedType = FullType.unspecified}) {
    final result = <Object?>[
      '__typename',
      serializers.serialize(object.G__typename,
  ...
  @override
  GautocompleteData_lemmasearch_message deserialize(
      Serializers serializers, Iterable<Object?> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new GautocompleteData_lemmasearch_messageBuilder();
...
class _$GautocompleteData_lemmasearch extends GautocompleteData_lemmasearch {
  ...
  final String G__typename;
  @override
  final BuiltList<GautocompleteData_lemmasearch_message?>? message;
  @override
  ...
  _$GautocompleteData_lemmasearch._(
      {required this.G__typename, this.message, this.lemmas})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(
...
class GautocompleteData_lemmasearchBuilder
  ...
  ListBuilder<GautocompleteData_lemmasearch_message?>? _message;
  ListBuilder<GautocompleteData_lemmasearch_message?> get message =>
      _$this._message ??=
          new ListBuilder<GautocompleteData_lemmasearch_message?>();
  set message(ListBuilder<GautocompleteData_lemmasearch_message?>? message) =>
...
class _$GautocompleteData_lemmasearch_message
    extends GautocompleteData_lemmasearch_message {
  @override
  final String G__typename;
  @override
  ...
  factory _$GautocompleteData_lemmasearch_message(
          [void Function(GautocompleteData_lemmasearch_messageBuilder)?
              updates]) =>
      (new GautocompleteData_lemmasearch_messageBuilder()..update(updates))
          ._build();

  _$GautocompleteData_lemmasearch_message._(
      {required this.G__typename, this.level, this.text})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(
        G__typename, r'GautocompleteData_lemmasearch_message', 'G__typename');
  }

  @override
  GautocompleteData_lemmasearch_message rebuild(
          void Function(GautocompleteData_lemmasearch_messageBuilder)
              updates) =>
      (toBuilder()..update(updates)).build();

  @override
  GautocompleteData_lemmasearch_messageBuilder toBuilder() =>
      new GautocompleteData_lemmasearch_messageBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is GautocompleteData_lemmasearch_message &&
        G__typename == other.G__typename &&
        level == other.level &&
        text == other.text;
  }
  ...
  String toString() {
    return (newBuiltValueToStringHelper(
            r'GautocompleteData_lemmasearch_message')
          ..add('G__typename', G__typename)
          ..add('level', level)
          ..add('text', text))
        .toString();
...
class GautocompleteData_lemmasearch_messageBuilder
    implements
        Builder<GautocompleteData_lemmasearch_message,
            GautocompleteData_lemmasearch_messageBuilder> {
  _$GautocompleteData_lemmasearch_message? _$v;
  ...
  GautocompleteData_lemmasearch_messageBuilder() {
    GautocompleteData_lemmasearch_message._initializeBuilder(this);
  }

  GautocompleteData_lemmasearch_messageBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _G__typename = $v.G__typename;
      _level = $v.level;
  ...
  @override
  void replace(GautocompleteData_lemmasearch_message other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$GautocompleteData_lemmasearch_message;
  }

  @override
  void update(
      void Function(GautocompleteData_lemmasearch_messageBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  GautocompleteData_lemmasearch_message build() => _build();

  _$GautocompleteData_lemmasearch_message _build() {
    final _$result = _$v ??
        new _$GautocompleteData_lemmasearch_message._(
            G__typename: BuiltValueNullFieldError.checkNotNull(G__typename,
                r'GautocompleteData_lemmasearch_message', 'G__typename'),
            level: level,
            text: text);
    replace(_$result);
    return _$result;
