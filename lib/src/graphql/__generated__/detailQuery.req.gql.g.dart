...
Serializer<GnoteReq> _$gnoteReqSerializer = new _$GnoteReqSerializer();
Serializer<GdefReq> _$gdefReqSerializer = new _$GdefReqSerializer();
...
class _$GnoteReqSerializer implements StructuredSerializer<GnoteReq> {
  @override
  final Iterable<Type> types = const [GnoteReq, _$GnoteReq];
  @override
  final String wireName = 'GnoteReq';

  @override
  Iterable<Object?> serialize(Serializers serializers, GnoteReq object,
      {FullType specifiedType = FullType.unspecified}) {
    final result = <Object?>[
      'vars',
      serializers.serialize(object.vars,
          specifiedType: const FullType(_i3.GnoteVars)),
      'document',
      serializers.serialize(object.document,
          specifiedType: const FullType(_i7.DocumentNode)),
      'idFields',
  ...
  @override
  GnoteReq deserialize(Serializers serializers, Iterable<Object?> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new GnoteReqBuilder();
    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        case 'vars':
          result.vars.replace(serializers.deserialize(value,
              specifiedType: const FullType(_i3.GnoteVars))! as _i3.GnoteVars);
          break;
        case 'document':
          result.document = serializers.deserialize(value,
                  specifiedType: const FullType(_i7.DocumentNode))!
...
class _$GdefReqSerializer implements StructuredSerializer<GdefReq> {
  @override
  final Iterable<Type> types = const [GdefReq, _$GdefReq];
  @override
  final String wireName = 'GdefReq';

  @override
  Iterable<Object?> serialize(Serializers serializers, GdefReq object,
      {FullType specifiedType = FullType.unspecified}) {
    final result = <Object?>[
      'vars',
      serializers.serialize(object.vars,
          specifiedType: const FullType(_i3.GdefVars)),
      'document',
      serializers.serialize(object.document,
          specifiedType: const FullType(_i7.DocumentNode)),
      'idFields',
  ...
  @override
  GdefReq deserialize(Serializers serializers, Iterable<Object?> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new GdefReqBuilder();
    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        case 'vars':
          result.vars.replace(serializers.deserialize(value,
              specifiedType: const FullType(_i3.GdefVars))! as _i3.GdefVars);
          break;
        case 'document':
          result.document = serializers.deserialize(value,
                  specifiedType: const FullType(_i7.DocumentNode))!
...
class _$GnoteReq extends GnoteReq {
  @override
  final _i3.GnoteVars vars;
  @override
  final _i7.DocumentNode document;
  @override
  final String? fragmentName;
  ...
  factory _$GnoteReq([void Function(GnoteReqBuilder)? updates]) =>
      (new GnoteReqBuilder()..update(updates))._build();
  ...
  _$GnoteReq._(
      ...
      required this.idFields})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(vars, r'GnoteReq', 'vars');
    BuiltValueNullFieldError.checkNotNull(document, r'GnoteReq', 'document');
    BuiltValueNullFieldError.checkNotNull(idFields, r'GnoteReq', 'idFields');
  }

  @override
  GnoteReq rebuild(void Function(GnoteReqBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  GnoteReqBuilder toBuilder() => new GnoteReqBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is GnoteReq &&
        vars == other.vars &&
        document == other.document &&
        fragmentName == other.fragmentName &&
        idFields == other.idFields;
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'GnoteReq')
          ..add('vars', vars)
          ..add('document', document)
          ..add('fragmentName', fragmentName)
          ..add('idFields', idFields))
...
class GnoteReqBuilder implements Builder<GnoteReq, GnoteReqBuilder> {
  _$GnoteReq? _$v;

  _i3.GnoteVarsBuilder? _vars;
  _i3.GnoteVarsBuilder get vars => _$this._vars ??= new _i3.GnoteVarsBuilder();
  set vars(_i3.GnoteVarsBuilder? vars) => _$this._vars = vars;
  ...
  GnoteReqBuilder() {
    GnoteReq._initializeBuilder(this);
  }

  GnoteReqBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _vars = $v.vars.toBuilder();
      _document = $v.document;
  ...
  @override
  void replace(GnoteReq other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$GnoteReq;
  }

  @override
  void update(void Function(GnoteReqBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  GnoteReq build() => _build();
    ...
    try {
      _$result = _$v ??
          new _$GnoteReq._(
              vars: vars.build(),
              document: BuiltValueNullFieldError.checkNotNull(
                  document, r'GnoteReq', 'document'),
              fragmentName: fragmentName,
              idFields: BuiltValueNullFieldError.checkNotNull(
                  idFields, r'GnoteReq', 'idFields'));
    } catch (_) {
      late String _$failedField;
      try {
        _$failedField = 'vars';
        ...
        throw new BuiltValueNestedFieldError(
            r'GnoteReq', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
...
class _$GdefReq extends GdefReq {
  @override
  final _i3.GdefVars vars;
  @override
  final _i7.DocumentNode document;
  @override
  final String? fragmentName;
  ...
  factory _$GdefReq([void Function(GdefReqBuilder)? updates]) =>
      (new GdefReqBuilder()..update(updates))._build();
  ...
  _$GdefReq._(
      ...
      required this.idFields})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(vars, r'GdefReq', 'vars');
    BuiltValueNullFieldError.checkNotNull(document, r'GdefReq', 'document');
    BuiltValueNullFieldError.checkNotNull(idFields, r'GdefReq', 'idFields');
  }

  @override
  GdefReq rebuild(void Function(GdefReqBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  GdefReqBuilder toBuilder() => new GdefReqBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is GdefReq &&
        vars == other.vars &&
        document == other.document &&
        fragmentName == other.fragmentName &&
        idFields == other.idFields;
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'GdefReq')
          ..add('vars', vars)
          ..add('document', document)
          ..add('fragmentName', fragmentName)
          ..add('idFields', idFields))
...
class GdefReqBuilder implements Builder<GdefReq, GdefReqBuilder> {
  _$GdefReq? _$v;

  _i3.GdefVarsBuilder? _vars;
  _i3.GdefVarsBuilder get vars => _$this._vars ??= new _i3.GdefVarsBuilder();
  set vars(_i3.GdefVarsBuilder? vars) => _$this._vars = vars;
  ...
  GdefReqBuilder() {
    GdefReq._initializeBuilder(this);
  }

  GdefReqBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _vars = $v.vars.toBuilder();
      _document = $v.document;
  ...
  @override
  void replace(GdefReq other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$GdefReq;
  }

  @override
  void update(void Function(GdefReqBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  GdefReq build() => _build();
    ...
    try {
      _$result = _$v ??
          new _$GdefReq._(
              vars: vars.build(),
              document: BuiltValueNullFieldError.checkNotNull(
                  document, r'GdefReq', 'document'),
              fragmentName: fragmentName,
              idFields: BuiltValueNullFieldError.checkNotNull(
                  idFields, r'GdefReq', 'idFields'));
    } catch (_) {
      late String _$failedField;
      try {
        _$failedField = 'vars';
        ...
        throw new BuiltValueNestedFieldError(
            r'GdefReq', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
